...
<strong>Update</strong>: there was a bug that had been fixed on trunk, but not in the installer that I used. <a href="../14/autotest-net-updated-now-and-then-notices-broken-builds/">AutoTest.Net is better at detecting broken builds</a> than I report below. 
...
<div class="images"><a href="{{ site.image_dir }}/autotest-winforms-messages.png"><img src="{{ site.image_dir }}/autotest-winforms-messages.png" alt="" title="autotest winforms messages" width="455" height="212" class="aligncenter size-full wp-image-782" /></a>
</div>
...
<div class="images">
<a href="{{ site.image_dir }}/innocuos-test-change-building.png"><img src="{{ site.image_dir }}/innocuos-test-change-building.png" alt="" title="innocuous test change building" width="538" height="231" class="aligncenter size-full wp-image-788" /></a>
<a href="{{ site.image_dir }}/innocuos-test-change-testing-done.png"><img src="{{ site.image_dir }}/innocuos-test-change-testing-done.png" alt="" title="innocuous test change testing done" width="538" height="231" class="aligncenter size-full wp-image-787" /></a>
</div>
...
<div class="images">
<a href="{{ site.image_dir }}/innocuous-core-change-testing-done.png"><img src="{{ site.image_dir }}/innocuous-core-change-testing-done.png" alt="" title="innocuous core change testing done" width="538" height="231" class="aligncenter size-full wp-image-790" /></a>
</div>
...
<div class="images">
<a href="{{ site.image_dir }}/breaking-test-change-after-test.png"><img src="{{ site.image_dir }}/breaking-test-change-after-test.png" alt="" title="breaking test change after test" width="602" height="335" class="aligncenter size-full wp-image-794" /></a>
</div>

Unfortunately, clicking the hyperlink didn't go so well:

<div class="images">
<a href="{{ site.image_dir }}/breaking-test-change-edit-source.png"><img src="{{ site.image_dir }}/breaking-test-change-edit-source.png" alt="" title="breaking test change edit source" width="603" height="373" class="aligncenter size-full wp-image-793" /></a>
</div>
