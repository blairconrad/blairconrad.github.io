...
At startup, each of these .ps1 files are each dot-sourced (using the <a href="../../../2010/01/29/expand-your-scope-you-can-dot-source-more-than-just-files/">dot-source from a function trick I talked about last time</a>).
